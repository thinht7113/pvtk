...
.method public static fromPlaybackState(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat;
    ...
    .line 469
    .local v18, "customActionObjs":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Object;>;"
    const/4 v13, 0x0

    .line 470
    .local v13, "customActions":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;>;"
    if-eqz v18, :cond_2

    .line 471
    new-instance v13, Ljava/util/ArrayList;

    .end local v13    # "customActions":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;>;"
    ...
    .line 472
    .restart local v13    # "customActions":Ljava/util/List;, "Ljava/util/List<Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;>;"
    ...
    .line 473
    .local v17, "customActionObj":Ljava/lang/Object;
    invoke-static/range {v17 .. v17}, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->fromCustomAction(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;
    ...
    .line 476
    .end local v17    # "customActionObj":Ljava/lang/Object;
...
.method public getPlaybackState()Ljava/lang/Object;
    ...
    .line 508
    .local v12, "customActions":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Object;>;"
    move-object/from16 v0, p0
    ...
    .end local v12    # "customActions":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Object;>;"
    move-object/from16 v0, p0
    ...
    .line 510
    .restart local v12    # "customActions":Ljava/util/List;, "Ljava/util/List<Ljava/lang/Object;>;"
    move-object/from16 v0, p0
    ...
    check-cast v16, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;

    .line 511
    .local v16, "customAction":Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;
    invoke-virtual/range {v16 .. v16}, Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;->getCustomAction()Ljava/lang/Object;
    ...
    .line 514
    .end local v16    # "customAction":Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;
    ...
    iget-wide v2, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->mPosition:J

    move-object/from16 v0, p0

    iget-wide v4, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->mBufferedPosition:J

    move-object/from16 v0, p0

    iget v6, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->mSpeed:F

    move-object/from16 v0, p0

    iget-wide v7, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->mActions:J

    move-object/from16 v0, p0

    iget-object v9, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->mErrorMessage:Ljava/lang/CharSequence;

    move-object/from16 v0, p0

    iget-wide v10, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->mUpdateTime:J

    move-object/from16 v0, p0

    iget-wide v13, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->mActiveItemId:J

    move-object/from16 v0, p0

    iget-object v15, v0, Landroid/support/v4/media/session/PlaybackStateCompat;->mExtras:Landroid/os/Bundle;

    invoke-static/range {v1 .. v15}, Landroid/support/v4/media/session/PlaybackStateCompatApi22;->newInstance(IJJFJLjava/lang/CharSequence;JLjava/util/List;JLandroid/os/Bundle;)Ljava/lang/Object;
    ...
    invoke-static/range {v1 .. v14}, Landroid/support/v4/media/session/PlaybackStateCompatApi21;->newInstance(IJJFJLjava/lang/CharSequence;JLjava/util/List;J)Ljava/lang/Object;
