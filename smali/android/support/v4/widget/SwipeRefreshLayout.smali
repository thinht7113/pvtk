...
.method private moveSpinner(F)V
    ...
    iget-boolean v12, v0, Landroid/support/v4/widget/SwipeRefreshLayout;->mUsingCustomStart:Z

    if-eqz v12, :cond_5

    move-object/from16 v0, p0

    iget v12, v0, Landroid/support/v4/widget/SwipeRefreshLayout;->mSpinnerFinalOffset:F
    ...
    .line 896
    .local v11, "tensionSlingshotPercent":F
    ...
    invoke-direct {v0, v12}, Landroid/support/v4/widget/SwipeRefreshLayout;->setAnimationProgress(F)V
    ...
    invoke-virtual {v12, v6}, Landroid/support/v4/widget/MaterialProgressDrawable;->setProgressRotation(F)V
    ...
    invoke-direct {v0, v12, v13}, Landroid/support/v4/widget/SwipeRefreshLayout;->setTargetOffsetTopAndBottom(IZ)V

    .line 930
    return-void

    .line 892
    .end local v3    # "extraMove":F
    .end local v6    # "rotation":F
    .end local v7    # "slingshotDist":F
    .end local v9    # "targetY":I
    .end local v10    # "tensionPercent":F
    .end local v11    # "tensionSlingshotPercent":F
    :cond_5
    move-object/from16 v0, p0
    ...
    .line 922
    .restart local v3    # "extraMove":F
    .restart local v7    # "slingshotDist":F
    .restart local v9    # "targetY":I
    .restart local v10    # "tensionPercent":F
    .restart local v11    # "tensionSlingshotPercent":F
    :cond_6
    move-object/from16 v0, p0
